...
function filteredChart1(data) {
    if (data == 0) {
        alert("Bu Ay Bilgisi Bulunamadı")
    }
    var root = am5.Root.new("chartdiv2");
    ...
    series.data.setAll([
        ...
        { value: data.data[0].adet, category: "Geçerli" },
        { value: data.data[1].adet, category: "Geçersiz" },
...
$("#kt_daterangepicker_1").on('apply.daterangepicker', function (ev, picker) {
    ...
    FilteDateByRange(startDate, endDate)
});

function FilteDateByRange(startDate, endDate) { 
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            alert("Grafik görüntülenemiyor.Bir şeyler ters gitti.");
        }
    });
}
